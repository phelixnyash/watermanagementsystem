...
<style type="text/css">
#data { margin: 0 auto; width:700px; padding:20px; border:#066 thin ridge; height:900px; }
...
<tr><td bordercolor="#000000">V.A.T: </td><td><b><i><?php echo $vat;?>
<tr><td bordercolor="#000000">FUEL charge: </td><td><b><i><?php echo $fuel;?>
<tr><td bordercolor="#000000">Forex charge: </td><td><b><i><?php echo $fchar;?>
<tr><td bordercolor="#000000">EPRA charge: </td><td><b><i><?php echo $epra;?>
<tr><td bordercolor="#000000">WRA charge: </td><td><b><i><?php echo $wra;?>
<tr><td bordercolor="#000000">REP charge: </td><td><b><i><?php echo $rep;?>
<tr><td bordercolor="#000000">inflation Adjustment: </td><td><b><i><?php echo $inf;?>
<td><b><i><?php echo $price; ?>&nbsp;kshs </td>
</tr>
<tr><td colspan="9"><center><h2>Total Invoice:<b><i> <?php echo $bill; ?><b><i> /= Kshs</h2></center></td></tr>
<?php
$session=$_SESSION['id'];
include 'db.php';
